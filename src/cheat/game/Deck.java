...
/**
 * Deck class that implements serializable and iterable. Contains all the methods
 * regarding the Deck object
 * @author Ash
 */
public class Deck implements Serializable, Iterable<Card> {
    ...
    /**
     * OddEvenIterator class which implements iterator. This creates a iterator that
     * iterates through all the odd placed elements with the deck then through all the
     * even objects
     */
